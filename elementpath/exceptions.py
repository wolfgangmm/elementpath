...
XPATH_ERROR_CODES = {
    ...
    # XQuery 3.1 errors (https://www.w3.org/TR/xquery-31/#id-errors)
    'XQST0022': (ElementPathSyntaxError,
                 'The value of a namespace declaration attribute is not a URILiteral'),
    'XQTY0024': (ElementPathTypeError,
                 'Attribute node after non-attribute content in an element constructor'),
    'XQDY0025': (ElementPathValueError,
                 'Duplicate attribute names in the result of an element constructor'),
    'XQDY0026': (ElementPathValueError,
                 "The content of a processing instruction contains '?>'"),
    'XQDY0041': (ElementPathValueError,
                 'The target of a processing instruction cannot be cast to xs:NCName'),
    'XQDY0044': (ElementPathValueError, 'Invalid name for a computed attribute'),
    'XQDY0064': (ElementPathValueError,
                 "The target of a processing instruction is equal to 'XML'"),
    'XQDY0072': (ElementPathValueError,
                 "The content of a computed comment contains '--' or ends with '-'"),
    'XQDY0074': (ElementPathValueError,
                 'The name of a computed node cannot be converted to an expanded QName'),
    'XQDY0096': (ElementPathValueError, 'Invalid name for a constructed element'),
    'XQDY0101': (ElementPathValueError, 'Invalid computed namespace constructor'),
    'XQST0040': (ElementPathValueError,
                 'Duplicate attribute names in a direct element constructor'),
    'XQST0071': (ElementPathValueError,
                 'Duplicate namespace declaration attributes in a direct element constructor'),
    'XQST0076': (ElementPathLocaleError, 'Unsupported collation in an order by clause'),
    'XQST0085': (ElementPathValueError,
                 'Namespace declaration attribute with a prefix and an empty URI'),
    'XQST0089': (ElementPathNameError,
                 'A positional variable has the same name of its for binding variable'),
    'XQST0090': (ElementPathValueError,
                 'Character reference does not identify a valid XML character'),
    'XQTY0105': (ElementPathTypeError,
                 'The content of an element constructor includes a function item'),
    'XQST0118': (ElementPathSyntaxError,
                 'The name in the end tag does not match the name in the start tag'),

    # XQuery 3.1 prolog and modules errors
    'XQST0009': (ElementPathValueError, 'Schema import is not supported'),
    'XQST0031': (ElementPathValueError, 'Unsupported version in a version declaration'),
    'XQST0032': (ElementPathValueError, 'Multiple base URI declarations in a prolog'),
    'XQST0033': (ElementPathValueError,
                 'Multiple declarations of the same namespace prefix in a prolog'),
    'XQST0034': (ElementPathValueError,
                 'Multiple functions declared with the same expanded name and arity'),
    'XQST0038': (ElementPathValueError,
                 'Multiple or unsupported default collation declarations in a prolog'),
    'XQST0045': (ElementPathValueError,
                 'The name of a declared function is in a reserved namespace'),
    'XQST0047': (ElementPathValueError, 'Multiple imports of the same module namespace'),
    'XQST0048': (ElementPathValueError,
                 'A declaration of a library module is not in the module namespace'),
    'XQST0049': (ElementPathValueError,
                 'Multiple variables declared with the same expanded name'),
    'XQST0054': (ElementPathValueError, 'A variable depends on itself'),
    'XQDY0054': (ElementPathValueError,
                 'A circular dependency in the initialization of a variable'),
    'XQST0055': (ElementPathValueError, 'Multiple copy-namespaces declarations in a prolog'),
    'XQST0059': (ElementPathValueError, 'Unable to locate or to process a module'),
    'XQST0060': (ElementPathValueError, 'The name of a declared function has no namespace'),
    'XQST0065': (ElementPathValueError, 'Multiple ordering mode declarations in a prolog'),
    'XQST0066': (ElementPathValueError,
                 'Multiple default element or function namespace declarations in a prolog'),
    'XQST0067': (ElementPathValueError, 'Multiple construction declarations in a prolog'),
    'XQST0068': (ElementPathValueError, 'Multiple boundary-space declarations in a prolog'),
    'XQST0069': (ElementPathValueError, 'Multiple empty order declarations in a prolog'),
    'XQST0087': (ElementPathValueError, 'Invalid encoding in a version declaration'),
    'XQST0088': (ElementPathValueError, 'Empty namespace URI in a module declaration or import'),
    'XQST0099': (ElementPathValueError, 'Multiple context item declarations in a prolog'),
    'XQST0106': (ElementPathValueError, 'Multiple %public or %private annotations'),
    'XQST0108': (ElementPathValueError, 'Output declaration in a library module'),
    'XQST0111': (ElementPathValueError, 'Multiple declarations of a decimal format'),
    'XQST0113': (ElementPathValueError, 'Context item declaration in a library module'),
    'XQST0114': (ElementPathValueError, 'Multiple declarations of a decimal format property'),
    'XQST0116': (ElementPathValueError,
                 'Multiple %public or %private annotations of a variable'),
    'XQST0125': (ElementPathValueError, 'An inline function has a %public or %private annotation'),
}
